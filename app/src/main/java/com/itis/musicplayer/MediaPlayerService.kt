...
class MediaPlayerService : Service(), MediaPlayer.OnCompletionListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnInfoListener, MediaPlayer.OnBufferingUpdateListener, AudioManager.OnAudioFocusChangeListener {
    ...
    companion object {
        const val ACTION_PLAY = "com.itis.musicplayer.ACTION_PLAY"
        const val ACTION_PAUSE = "com.itis.musicplayer.ACTION_PAUSE"
        const val ACTION_PREVIOUS = "com.itis.musicplayer.ACTION_PREVIOUS"
        const val ACTION_NEXT = "com.itis.musicplayer.ACTION_NEXT"
        const val ACTION_STOP = "com.itis.musicplayer.ACTION_STOP"
